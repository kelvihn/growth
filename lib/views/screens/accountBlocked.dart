...
class AccountBlocked extends StatefulWidget {
  const AccountBlocked({Key? key}) : super(key: key);
        ...
        child: Center(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'It seems your account has been blocked due to upgrade issues. Kindly report this problem to our live chat via the GSBC website. ',
